# React Native vs Jetpack Compose

## 1. Goal
Understand the overall platform model and build your first RN screen.
...
React Native UI is also declarative, but it renders native views through the React bridge/runtime.

## 5. Compose vs React Native Comparison
| Compose | React Native |
|---|---|
| Composable functions | Function components |
| Modifier | StyleSheet styles |
| State hoisting | Props + callbacks |

## 6. Code Practice Setup
- Open `App.tsx` in your local RN project.
- Replace full file content.
- This is a full `App.tsx` replacement.
...
## 9. Expected Output
A centered card with title, subtitle, and a button.
...
```md
![Screenshot](../screenshots/01-01-react-native-vs-compose.png)
```
